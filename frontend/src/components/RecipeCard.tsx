...
export function RecipeCard({ recipe, favorited, onToggleFav }: RecipeCardProps) {
  ...
  return (
    <motion.article
      ...
      className="group relative overflow-hidden rounded-card border border-line-soft bg-white"
    >
      <Link to={`/cong-thuc/${recipe.id}`} className="block outline-none focus-visible:ring-2 focus-visible:ring-accent/40">
